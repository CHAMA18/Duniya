...
#     the Flutter SPA shell to /app.html. NOTE: Render static sites
#     do NOT support SPA fallback via _redirects reliably — deep
#     links like /supplierManagement still 404 on reload. Workaround
#     for users: deep-link via /app.html?route=/supplierManagement
#     (which works as a real-file direct access).
# ---------------------------------------------------------------------
