...
class _StockMovementsWidgetState extends State<StockMovementsWidget> {
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              // ═══ HEADER ═══
                              _buildPageHeader(context, theme, primaryColor, onSurface, onSurfaceVariant, outlineVariant, cardBg),
                              SizedBox(height: 24.0),

                              // ═══ EXECUTIVE METRICS (4 cards) ═══
                              _buildMetricCards(context, theme, primaryColor, onSurface, onSurfaceVariant, outlineVariant, cardBg),
                              SizedBox(height: 24.0),

                              // ═══ MAIN CONTENT: Analytics + Ledger ═══
                              // Analytics Chart
                              _buildAnalyticsChart(context, theme, primaryColor, onSurface, onSurfaceVariant, outlineVariant, cardBg),
                              SizedBox(height: 24.0),
                              ...
                              AuthUserStreamWidget(
                                builder: (context) =>
                                  ...
                                  builder: (context, snapshot) {
                                    if (!snapshot.hasData) {
                                      return _buildLoadingCard(cardBg, outlineVariant, theme);
                                    }
                                    List<StockMovementRecord> movements = snapshot.data!;
                                    // Apply filter
                                    ...
                                    return FutureBuilder<List<ProductMasterRecord>>(
                                      ...
                                      builder: (context, productSnapshot) {
                                        ...
                                        return _buildMovementLedger(
                                          context, movements, productMap, theme,
                                          primaryColor, onSurface, onSurfaceVariant,
  ...
  Widget _buildPageHeader(
    BuildContext context, FlutterFlowTheme theme, Color primaryColor,
    Color onSurface, Color onSurfaceVariant, Color outlineVariant,
    Color cardBg,
  ) {
    return Card(
      elevation: 0,
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: outlineVariant.withValues(alpha: 0.3), width: 0.5),
      ),
          ...
          builder: (context, constraints) {
            ...
            if (isWide) {
              return Row(
                ...
                children: [
                  _buildHeaderLeft(theme, primaryColor, onSurface, onSurfaceVariant),
                  _buildHeaderActions(context, theme, primaryColor, onSurface, onSurfaceVariant, outlineVariant, cardBg),
                ],
              );
            }
            return Column(
  ...
  Widget _buildHeaderLeft(FlutterFlowTheme theme, Color primaryColor, Color onSurface, Color onSurfaceVariant) {
    return Row(
      children: [
        Container(
          width: 40.0,
  ...
  Widget _buildHeaderActions(
    BuildContext context, FlutterFlowTheme theme, Color primaryColor,
    Color onSurface, Color onSurfaceVariant, Color outlineVariant, Color cardBg,
  ) {
    return Wrap(
      spacing: 12.0,
      runSpacing: 8.0,
      ...
      children: [
        ...
        Container(
          ...
          child: FlutterFlowDropDown<String>(
            ...
            onChanged: (val) => safeSetState(() => _model.movementTypeValue = val),
            width: 180.0,
            height: 44.0,
            ...
            builder: (context, snapshot) {
              if (!snapshot.hasData) {
                return Container(
                  ...
                  child: Center(child: SpinKitRing(color: primaryColor, size: 16.0)),
                );
              }
              return Container(
                width: 180.0,
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  onChanged: (val) => safeSetState(() => _model.pharmacyValue = val),
                  width: 180.0,
                  height: 44.0,
                  textStyle: theme.bodyMedium,
      ...
      builder: (context, constraints) {
        ...
        return Wrap(
          ...
          children: metrics.map((m) {
            final width = (constraints.maxWidth - (columns - 1) * 16.0) / columns;
            return SizedBox(
              width: width,
              child: _buildMetricCard(m, theme, onSurface, onSurfaceVariant, outlineVariant, cardBg),
            );
          }).toList(),
        );
      },
  ...
  Widget _buildMetricCard(
    _MetricData m, FlutterFlowTheme theme, Color onSurface,
    Color onSurfaceVariant, Color outlineVariant, Color cardBg,
  ) {
    return Card(
      elevation: 2.0,
      color: cardBg,
      ...
      child: Column(
        ...
        children: [
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: isActive
                                ? [BoxShadow(color: Colors.black.withValues(alpha: 0.08), blurRadius: 2, offset: Offset(0, 1))]
                                : null,
                          ),
                          child: Text(
                            period,
          ...
          Container(
            height: 220.0,
            padding: EdgeInsets.symmetric(horizontal: 24.0, vertical: 16.0),
            child: _buildBarChart(primaryColor, outlineVariant, onSurface, onSurfaceVariant),
          ),
        ],
      ),
    );
  ...
  Widget _buildBarChart(Color primaryColor, Color outlineVariant, Color onSurface, Color onSurfaceVariant) {
    final bars = [
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final barWidth = (constraints.maxWidth - (bars.length - 1) * 8.0) / bars.length;
        return Row(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: bar.isHighlight
                            ? [BoxShadow(color: primaryColor.withValues(alpha: 0.3), blurRadius: 8, offset: Offset(0, 2))]
                            : null,
                      ),
                    ),
                  ],
  ...
  Widget _buildMovementLedger(
    BuildContext context, List<StockMovementRecord> movements,
    Map<String, ProductMasterRecord> productMap, FlutterFlowTheme theme,
    Color primaryColor, Color onSurface, Color onSurfaceVariant,
    Color outlineVariant, Color cardBg,
  ) {
    ...
    final end = start + pageSize > movements.length ? movements.length : start + pageSize;
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: _buildTable(
                pageMovements, productMap, theme, primaryColor,
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: _model.currentPage! > 1
                          ? () => safeSetState(() => _model.currentPage = _model.currentPage! - 1)
                          : null,
                      child: Container(
                        padding: EdgeInsets.all(4.0),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(4.0),
                          color: _model.currentPage! > 1 ? null : Colors.transparent,
                        ),
                        child: Icon(Icons.chevron_left, size: 16.0,
                          color: _model.currentPage! > 1 ? onSurfaceVariant : onSurfaceVariant.withValues(alpha: 0.4)),
                      ),
                    ),
                    // Page numbers
                    ...List.generate(totalPages.clamp(1, 5), (i) {
                      ...
                      return GestureDetector(
                        onTap: () => safeSetState(() => _model.currentPage = page),
                        child: Container(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.chevron_right, size: 16.0,
                          color: _model.currentPage! < totalPages ? onSurfaceVariant : onSurfaceVariant.withValues(alpha: 0.4)),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildTable(
    List<StockMovementRecord> movements, Map<String, ProductMasterRecord> productMap,
    FlutterFlowTheme theme, Color primaryColor, Color onSurface,
    ...
    return DataTable(
      ...
      columns: [
        DataColumn(label: Text('Date/Time', style: _headerStyle(onSurfaceVariant))),
        DataColumn(label: Text('Product', style: _headerStyle(onSurfaceVariant))),
        DataColumn(label: Text('Type', style: _headerStyle(onSurfaceVariant))),
        DataColumn(label: Text('Quantity', style: _headerStyle(onSurfaceVariant))),
        DataColumn(label: Text('Source / Destination', style: _headerStyle(onSurfaceVariant))),
        DataColumn(label: Text('Status', style: _headerStyle(onSurfaceVariant))),
      ],
      rows: movements.map((movement) {
        ...
        return DataRow(
          cells: [
            ...
            DataCell(Row(
              ...
              children: [
                Container(
                  ...
                  child: Icon(_getProductIcon(product?.name), color: primaryColor, size: 16.0),
                ),
                SizedBox(width: 8.0),
                Flexible(child: Text(
            ...
            // Status
            DataCell(_buildStatusBadge(mType, primaryColor, onSurfaceVariant, outlineVariant)),
          ],
        );
      }).toList(),
    );
  ...
  TextStyle _cellStyle(Color color, {FontWeight weight = FontWeight.w400}) => TextStyle(
    fontFamily: 'Satoshi',
    fontSize: 13.0,
    fontWeight: weight,
    letterSpacing: -0.01,
  ...
  Widget _buildTypeBadge(String type, Color primaryColor, Color onSurfaceVariant) {
    IconData icon;
    Color color;
    String label;
    switch (type) {
    ...
    return Row(
      ...
      children: [
        ...
        Text(label, style: TextStyle(
          fontFamily: 'Satoshi', fontSize: 13.0, fontWeight: FontWeight.w500, color: color,
        )),
      ],
    );
  }

  Widget _buildStatusBadge(String type, Color primaryColor, Color onSurfaceVariant, Color outlineVariant) {
    ...
    if (type == 'TRANSFERRED') {
      return Container(
        ...
        child: Text('IN TRANSIT', style: TextStyle(
          fontFamily: 'Satoshi', fontSize: 10.0, fontWeight: FontWeight.w600,
          letterSpacing: 0.04, color: onSurfaceVariant,
        )),
      );
    }
    return Container(
      ...
      child: Text('COMPLETED', style: TextStyle(
        fontFamily: 'Satoshi', fontSize: 10.0, fontWeight: FontWeight.w600,
        letterSpacing: 0.04, color: primaryColor,
      )),
    );
  }
  ...
  IconData _getProductIcon(String? name) {
    ...
    if (lower.contains('caps') || lower.contains('tablet')) return Icons.vaccines;
    if (lower.contains('susp') || lower.contains('syrup') || lower.contains('liquid')) return Icons.medication_liquid;
    if (lower.contains('cream') || lower.contains('oint')) return Icons.healing;
    if (lower.contains('inject')) return Icons.vaccines;
    if (lower.contains('gauze') || lower.contains('pad') || lower.contains('bandage')) return Icons.healing;
  ...
  Widget _buildEmptyState(FlutterFlowTheme theme, Color onSurfaceVariant) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12.0),
        side: BorderSide(color: theme.lineColor.withValues(alpha: 0.3), width: 0.5),
      ),
      margin: EdgeInsets.zero,
      child: Container(
        height: 300.0,
        child: Center(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.swap_horiz, size: 64.0, color: onSurfaceVariant.withValues(alpha: 0.4)),
              SizedBox(height: 16.0),
              Text(
  ...
  // LOADING STATE
  // ═══════════════════════════════════════════════════════════
  Widget _buildLoadingCard(Color cardBg, Color outlineVariant, FlutterFlowTheme theme) {
    return Card(
      elevation: 2.0,
      color: cardBg,
      shadowColor: Colors.black.withValues(alpha: 0.06),
              ...
              child: Column(
                ...
                children: [
                  StreamBuilder<List<ProductMasterRecord>>(
                    ...
                    builder: (context, snapshot) {
                      if (!snapshot.hasData) {
                        return SpinKitRing(color: FlutterFlowTheme.of(context).primary, size: 20.0);
                      }
                      return FlutterFlowDropDown<String>(
                        controller: _model.dialogProductValueController ??=
                            FormFieldController<String>(null),
                        options: snapshot.data!.map((p) => p.name).toList(),
                        onChanged: (val) => safeSetState(() => _model.dialogProductValue = val),
                  ...
                  FlutterFlowDropDown<String>(
                    ...
                    onChanged: (val) => safeSetState(() => _model.dialogMovementTypeValue = val),
                    width: double.infinity,
                    height: 44.0,
                    textStyle: FlutterFlowTheme.of(context).bodyMedium,
                    hintText: 'Movement Type',
              ...
              onPressed: () async {
                ...
                await StockMovementRecord.createDoc(ownerRef).set(
                    createStockMovementRecordData(
                      ...
                      quantity: int.tryParse(_model.dialogQtyTextController?.text ?? '0') ?? 0,
...
class _BarData {
  ...
  _BarData({required this.height, required this.value, required this.isHighlight});
}
