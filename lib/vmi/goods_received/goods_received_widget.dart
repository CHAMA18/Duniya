                                                              ...
                                                              Wrap(
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child: FutureBuilder<
                                                                        PharmacyRecord?>(
                                                                      future: receipt.outletId !=
                                                                              null
                                                                          ? PharmacyRecord.getDocumentOnce(receipt
                                                                              .outletId!)
                                                                          : Future.value(
                                                                              null),
                                                                      builder:
                                                                          (context,
                                                                              pharmacySnapshot) {
                                                                        return Text(
                                                                          pharmacySnapshot.hasData && pharmacySnapshot.data != null && pharmacySnapshot.data!.name.isNotEmpty
