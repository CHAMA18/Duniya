              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'ADDSTORES_chevron_left_rounded_ICN_ON_TA');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ADDSTORES_PAGE_SAVE_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_backend_call');
                                                          ...
                                                          builder:
                                                            ...
                                                            return WebViewAware(
                                                              child:
                                                                  AlertDialog(
                                                                title: Text(
                                                                    'Congratulations new Pharmacy added'),
                                                                content: Text(
                                                                    'View store on the next page'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
