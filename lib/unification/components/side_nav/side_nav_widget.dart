            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Container_xein5tez_ON_TAP');
                ...
                // ─── Point Of Sale (highlighted marquee section — pharmacy users) ───
                if (!_isDuniyaUser)
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(
                      isCollapsed ? 8.0 : 12.0,
                      4.0,
                      isCollapsed ? 8.0 : 12.0,
                      4.0,
                    ),
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          focusColor: Colors.transparent,
                          hoverColor: FlutterFlowTheme.of(context).primary.withValues(alpha: 0.08),
                          highlightColor: Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          onTap: () async {
                            logFirebaseEvent('SIDE_NAV_PointOfSale_ON_TAP');
                            logFirebaseEvent('SidebarLink_navigate_to');
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (!isCollapsed) ...[
                                        ...
                                        Text(
                                          ...
                                          style: FlutterFlowTheme.of(context)
                                              ...
                                              .override(
                                                ...
                                                color: FFAppState().SelectedPage == 'Point Of Sale'
                                  ...
                                  if (FFAppState().SelectedPage == 'Point Of Sale')
                                    Container(
                                      width: 3.0,
                                      height: 24.0,
                                      decoration: BoxDecoration(
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Container_s5ds1au0_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                ...
                AuthUserStreamWidget(
                  builder: (context) => InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('SIDE_NAV_COMP_PendingApprovals_ON_TAP');
                      logFirebaseEvent('SidebarLink_navigate_to');
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Container_2ctlhwc2_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Store Inventory',
                    ),
                  ),
                ),
                // Product Catalogue
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Product_Catalogue_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Stock_Balances_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Stock Balances',
                    ),
                  ),
                ),
                // Stock Movements
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Stock_Movements_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Stock Movements',
                    ),
                  ),
                ),
                // Stock Counts
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Stock_Counts_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Stock Counts',
                    ),
                  ),
                ),
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Goods_Received_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Goods Received',
                    ),
                  ),
                ),
                // Sales / Dispensing
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Sales_Dispensing_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Batch_Expiry_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Batch & Expiry',
                    ),
                  ),
                ),
                // Low Stock Alerts
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Low_Stock_Alerts_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Low Stock Alerts',
                    ),
                  ),
                ),
                // Replenishment
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('SIDE_NAV_COMP_Replenishment_ON_TAP');
                    logFirebaseEvent('SidebarLink_navigate_to');
                  ...
                  child: wrapWithModel(
                    ...
                    child: SidebarLinkWidget(
                      ...
                      isActive: FFAppState().SelectedPage == 'Replenishment',
                    ),
                  ),
                ),
                      ...
                      if (_isDuniyaUser)
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            logFirebaseEvent('SidebarLink_navigate_to');
                            context
                                .goNamed(DuniyaStockBalancesWidget.routeName);
                            logFirebaseEvent('SidebarLink_update_app_state');
