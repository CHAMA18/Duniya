                                          ...
                                          if (responsiveVisibility(
                                            ...
                                            AutoSizeText(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '0o284amy' /* Here's an overview of your pha... */,
                                              ),
                                              minFontSize: 8.0,
                                              style:
                                        ...
                                        builder: (context) =>
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_PAGE_Container_9uh40wrj_ON_TAP');
                                                logFirebaseEvent(
                                          ...
                                          builder: (context) =>
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_PAGE_Container_4yrdto0x_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Container_navigate_to');
                                        ...
                                        builder: (context) =>
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_PAGE_Container_mr4x74cf_ON_TAP');
                                                logFirebaseEvent(
                                                    'Container_navigate_to');
                                      ...
                                      child: Wrap(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'HOME_PAGE_Column_49msq5ho_ON_TAP');
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            AuthUserStreamWidget(
                                              builder: (context) => InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_PAGE_Column_zxagbspu_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Column_navigate_to');
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'HOME_PAGE_Column_7co0eyhq_ON_TAP');
                                              logFirebaseEvent(
                                                  'Column_navigate_to');

                                              context.goNamed(
                                                  BMICalcWidget.routeName);
                                            },
                                            child: Column(
                                              mainAxisSize: MainAxisSize.max,
                                              children: [
